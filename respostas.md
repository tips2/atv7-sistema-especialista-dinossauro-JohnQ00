...
As perguntas são feitas de forma estática, apenas a base de conhecimento vai sendo limitada a fim de encontrar a resposta.
...
Sim, utiliza encadeamento para frente.
